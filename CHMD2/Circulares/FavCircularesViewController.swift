   ...
   func contextualDelAction(forRowAtIndexPath indexPath: IndexPath) -> UIContextualAction {
    ...
    func leerCirculares(){
          ...
          */
            ...
            let consulta = "SELECT idCircular,nombre,textoCircular,leida,favorita,eliminada,fecha,fechaIcs,horaInicioIcs,horaFinIcs,nivel,especiales  FROM appCircularCHMD WHERE favorita=1 AND eliminada=0 AND tipo=1  ORDER BY idCircular DESC"
